insert into machine_interface (name, connection_direction, connection_type, server_hostname, server_port, server_username, server_password)
    values
...
insert into machine_interface (name, connection_direction, connection_type, server_hostname, server_port, server_username, server_password, remote_directory)
values
